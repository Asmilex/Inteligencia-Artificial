...
public:
    ...
    int                 cb_click_type;
    int                 last_line;
    //Cambiado de int para resolver el problema que daba en arquitecturas de 64bits
    //segun este reporte de error: http://sourceforge.net/p/glui/discussion/319502/thread/3ec6a2f8/
    unsigned long int last_click_time;
