...
char life_time_input[1000]="2000",total_runs_input[1000]="10",file_name_input[1000]="map/feromona1.map";
...
void GUI::control_cb(int id){
	switch(id){
		...
		case DISPLAY_BTN_ID:
			if(true){
				long long tsleep = atol(display_time);
...
int GUI::startDraw(int argc,char **argv){
	...
	int main_window=glutCreateWindow("Ejercicio 1 - Feromonas");
...
void GUI::showScore(){
    ...
    switch(env->OutOfBoderTime()){
        case 0: sout << " ";
                break;
        case 1: sout << "        Hormiga: Oh! Oh!";
                break;
        case 2: sout << "        Hormiga: Te llamo cuando llegue!!";
                break;
        case 3: sout << "        Hormiga: No es que no me fie de ti, pero sabes donde me llevas?!?!";
                break;
        case 4: sout << "        Hormiga: Perdoname que insista, no es evidente que no me has programado bien!!!";
                break;
        case 5: sout << "        Hormiga: No, y seras capaz de darle otra vez al botoncito!!!!";
                break;
        case 6: sout << "        Hormiga: Nada, tu a lo tuyo, tu sigue pulsando el botoncito dichoso!!!!";
                break;
        case 7: sout << "        Hormiga: Espera, espera, veo un cartel... Murcia 3 Kms";
                break;
        case 8: sout << "        Hormiga: T..e.. est..oy......perd..ie..ndo..";
                break;
        default: sout << "       Hormiga no disponible o fuera de cobertura";
    }
