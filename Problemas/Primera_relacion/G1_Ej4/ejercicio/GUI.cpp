...
char life_time_input[1000]="2000",total_runs_input[1000]="10",file_name_input[1000]="map/mapa1.map";
...
int GUI::startDraw(int argc,char **argv){
	...
	int main_window=glutCreateWindow("Ejercicio 4 - Golpe");
...
void GUI::newGame(){
	...
	if(fin){
		...
		agent=new Agent(env->ObjPosX(), env->ObjPosY());
